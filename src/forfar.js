...
//         // document.getElementById("goHome").dispatchEvent(event);
...
//     //   return (this.state.hide===false) ? this.setState(state => ({ hide: true})) : this.setState(state => ({ hide: false}));
//     // }
//     render (){
...
//             {/* <button onClick={this.hideButton} className={this.state.class}>
//               {this.state.label}
//             </button> */}
//             {/* {this.state.hide && <Example />} */}
